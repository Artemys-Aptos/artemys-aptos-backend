...
4. **Start the Celery worker:** `celery -A app.celery.celery worker --loglevel=info`
5. **Start the Celery beat scheduler:** `celery -A app.celery.celery beat --loglevel=info`
